 ...
 *
 * $Header: //depot/release/Embedded/Components/Qorvo/OS/v2.10.2.5/comps/gpSched/patch/gpSched_integration_calls_patch.c#1 $
 * $Change: 191147 $
...
STATIC_FUNC void Sched_RescheduleEventAbs (UInt32 time, gpSched_Event_t * pevt)
{
    ...
    //Signal new event to main handler thread
